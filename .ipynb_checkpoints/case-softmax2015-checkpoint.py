...
parser.add_argument('--dataset', type=str, default='twitter2015', choices=['twitter2015', 'twitter2017', 'case'])
...
# model_path = 'model_weights/2017_uncertainty_fusion-tic/2024-04-17_19-47-16_twitter2017/model_bs4_lr1e-05_seed0_epoch5.pt'
...
model_path = 'model_weights/2015_uncertainty_fusion_softmax/2024-04-18_17-58-28_twitter2015/model_bs4_lr1e-05_seed0.pt'
...
def save_results_json(batch_results, filename="case_results_softmax_ng_2015.json"):
